...
fake_requests.get = lambda *args, **kwargs: (_ for _ in ()).throw(RuntimeError("requests stub"))
...
fake_html.fromstring = lambda *_args, **_kwargs: (_ for _ in ()).throw(RuntimeError("lxml stub"))

fake_lxml = types.ModuleType("lxml")
fake_lxml.html = fake_html

fake_feedparser = types.ModuleType("feedparser")
fake_feedparser.parse = lambda *_args, **_kwargs: (_ for _ in ()).throw(RuntimeError("feedparser stub"))
